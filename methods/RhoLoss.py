...
class RhoLoss(SelectionMethod):
    ...
    def reducible_loss_selection(
        self, inputs, targets, indexes, number_to_select, epoch
    ):
        ...
        _, index_selected = torch.topk(
            reducible_loss, k=number_to_select, largest=True, sorted=False
        )
    ...
    def before_batch(self, i, inputs, targets, indexes, epoch):
        ...
        indices = self.reducible_loss_selection(
            inputs, targets, indexes, number_to_select, epoch
        )
