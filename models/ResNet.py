...
def create_model(m_type='resnet101',num_classes=1000, pretrained = False, in_channels=3):
    if not pretrained:
        if m_type == 'resnet18':
            model = ResNet18(num_classes, in_channels=in_channels)
        elif m_type == 'resnet34':
            model = ResNet34(num_classes, in_channels=in_channels)
        elif m_type == 'resnet50':
            model = ResNet50(num_classes, in_channels=in_channels)
        elif m_type == 'resnet101':
            model = ResNet101(num_classes, in_channels=in_channels)
        elif m_type == 'resnet152':
            model = ResNet152(num_classes, in_channels=in_channels)
        else:
